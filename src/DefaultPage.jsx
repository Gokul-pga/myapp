...
function DefaultPage() {
  ...
  return (
    ...
    <Box sx={{display:'flex',width:'100%'}}>
        <Stack sx={{flexDirection:'row',width:'100%',alignItems:'center',justifyContent:'space-between',gap:2}}>
            <Box sx={{backgroundColor:'palegreen',width:'25%',padding:'20px',textAlign:'center',borderRadius:'10px'}}>
